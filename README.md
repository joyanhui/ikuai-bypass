...
爱快有简单易用的分流功能可以实现诸多功能，但是因为大家喜闻乐见的分流规则数据可能几万条，在ikuai上维护更新比较麻烦，这个工具就是为了自动从订阅地址更新爱快的分流规则的域名分流和运营商分流。

> 如有bug反馈和建议都可以提[issues](https://github.com/joyanhui/ikuai-bypass/issues)，我会尽快处理。给个star我会很开心。

### ip分组和端口分流方式 说明：
ikuai 可以通过分流规则 让国内ip直连，非国内ip指定下一跳网关到openwrt。openwrt处理后，再把出口流量给上游运营商。实现方式参考[[#7]](https://github.com/joyanhui/ikuai-bypass/issues/7) 或者 [[恩山y2kji]](https://www.right.com.cn/forum/thread-8288009-1-1.html) 或B站网友的教程
### 自定义运营商分流方式 说明：
...
## 更新日志
- 2024-06-29 修复清理模式无法清理ip分组和端口分流规则的问题
