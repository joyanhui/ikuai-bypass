...
### 版本选择
- [v4.4.5-Pre](https://github.com/joyanhui/ikuai-bypass/releases/tag/v4.4.5-Pre) 初步适配爱快v4内测版本，此版本不兼容爱快3.x版本。并且进行了很大的调整，并需要修改配置项 详情请看更新日志。
...
## 更新日志
- 2026-02-24 适配 iKuai8_x64_4.0.101 对tag长度和api域名分流90kb的限制
