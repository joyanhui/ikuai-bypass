...
const ZH: Dict = {
  ...
  'config.github_proxy.smart_hint': '只用于下载规则/远程载入，不会影响新版检查。',
  'config.proxy.diff': '不确定怎么选？推荐用“智能推荐”。系统里已经设置代理就选“跟随系统”。需要指定代理地址再选“手动设置”。',
...
const EN: Dict = {
  ...
  'about.update.hint.idle': 'Click “Check Updates” to see if there is a newer version.',
  ...
  'config.github_proxy.smart_hint': 'Only for downloading rules/remote template; not used for update check.',
  'config.proxy.diff': 'Not sure? Use “Smart”. If your system proxy is already set, choose “Use System”. Need to specify a proxy URL? Choose “Manual”.',
  ...
  'remote.proxy_note': 'Remote load will download using your network settings.',
