...
const ZH: Dict = {
  ...
  'config.basic.desc': '爱快连接、代理、WebUI、分页参数',
  'config.basic.toggle': '展开',
  'config.section.ikuai': 'iKuai 连接',
  'config.section.schedule': '调度与代理',
  'config.proxy.mode': '代理模式',
  'config.proxy.url': '代理地址',
  'config.proxy.mode.custom': '自定义代理',
  'config.proxy.mode.system': '系统代理',
  'config.proxy.mode.onlyGithubApi': '仅 GitHub API',
  'config.proxy.mode.disabled': '禁用代理',
  'config.github_proxy': 'GitHub Proxy (ghproxy)',
  'config.proxy.diff': '说明：proxy 是全局 HTTP 代理，会影响爱快/规则下载/GitHub API；github-proxy(ghproxy) 是 URL 前缀重写，仅对 GitHub Raw 下载加速。',
  'config.section.webui': 'WebUI 设置',
  'config.section.pagination': '数据分页',

  'remote.title': '远程载入',
  'remote.cover_notice': '使用远程配置覆盖本地配置。',
  'remote.use_proxy': '使用 ghproxy 代理',
  'remote.proxy_label': 'GitHub Proxy 地址',
  'remote.proxy_hint': '仅对 raw.githubusercontent.com / github.com 生效。',
  'remote.btn_load': '加载',
...
const EN: Dict = {
  ...
  'config.basic.desc': 'iKuai connection, proxy, WebUI, pagination',
  'config.basic.toggle': 'Expand',
  'config.section.ikuai': 'iKuai Connection',
  'config.section.schedule': 'Schedule & Proxy',
  ...
  'config.proxy.mode.onlyGithubApi': 'Only GitHub API',
  'config.proxy.mode.disabled': 'Disable Proxy',
  'config.github_proxy': 'GitHub Proxy (ghproxy)',
  'config.proxy.diff': 'Note: proxy is a global HTTP proxy (iKuai/rule downloads/GitHub API). github-proxy (ghproxy) is URL prefix rewriting for GitHub Raw acceleration only.',
  ...
  'remote.use_proxy': 'Use ghproxy',
  'remote.proxy_label': 'GitHub Proxy',
  'remote.proxy_hint': 'Only applies to raw.githubusercontent.com / github.com.',
