...
func UpdateStreamIpPort(iKuai *ikuai_api.IKuai, forwardType string, tag string, iface string, nexthop string, srcAddr string, ipGroupName string, mode int, ifaceband int) (err error) {
